...
import Expressions.ltExpression;
import Repository.*;
import Statements.*;
public class Interpreter {
	public static void main(String[] args)
	{
		...
		PrgState state = new PrgState(stk, symtbl, out, filetable,heap, ex1);
		...
		PrgState state1 = new PrgState(stk1, symtbl1, out1, filetable1,heap1,ex2);
		...
		PrgState state2 = new PrgState(stk2, symtbl2, out2, filetable2,heap2,ex3);
		...
		PrgState state3 = new PrgState(stk3, symtbl3, out3, filetable3,heap3,ex4);
		...
		PrgState state4 = new PrgState(stk4, symtbl4, out4, filetable4,heap4,ex5);
